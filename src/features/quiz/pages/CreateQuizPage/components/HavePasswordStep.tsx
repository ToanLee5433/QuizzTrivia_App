...
interface HavePasswordStepProps {
  ...
  password?: string;
  onChange: (field: 'havePassword' | 'password', value: string) => void;
}
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Public Option */}
        <div 
          onClick={() => onChange('havePassword', 'public')} 
        ...
        {/* Password Option */}
        <div 
          onClick={() => onChange('havePassword', 'password')} 
          className={`cursor-pointer rounded-2xl p-6 transition-all transform hover:scale-105 ${
...
export default HavePasswordStep;
