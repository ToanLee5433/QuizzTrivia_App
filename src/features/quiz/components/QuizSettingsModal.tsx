            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold">
                  {t('quizSettings.title', 'Cài đặt Quiz')}
                </h2>
                <p className="text-sm text-blue-100">
                  {t('quizSettings.subtitle', 'Tùy chỉnh trải nghiệm làm quiz của bạn')}
                </p>
              </div>
            </div>
            <button
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white">
                  {t('quizSettings.timePerQuestion', 'Thời gian mỗi câu')}
                </h3>
              </div>
              <select
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                {t('quizSettings.timeDesc', 'Thời gian giới hạn cho mỗi câu hỏi. Chọn "Không giới hạn" để không đặt thời gian.')}
              </p>
            </div>
            ...
            <div className="flex items-start justify-between p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white">
                    {t('quizSettings.shuffleQuestions', 'Trộn câu hỏi')}
                  </h3>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t('quizSettings.shuffleQuestionsDesc', 'Hiển thị câu hỏi theo thứ tự ngẫu nhiên')}
                </p>
              </div>
            ...
            <div className="flex items-start justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white">
                    {t('quizSettings.shuffleAnswers', 'Trộn đáp án')}
                  </h3>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t('quizSettings.shuffleAnswersDesc', 'Hiển thị các lựa chọn theo thứ tự ngẫu nhiên')}
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                <input
            ...
            <div className="flex items-start justify-between p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white">
                    {t('quizSettings.showExplanations', 'Hiển thị giải thích')}
                  </h3>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t('quizSettings.showExplanationsDesc', 'Hiển thị giải thích sau khi trả lời')}
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                <input
            ...
            <div className="flex items-start justify-between p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white">
                    {t('quizSettings.autoSubmit', 'Tự động nộp bài')}
                  </h3>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t('quizSettings.autoSubmitDesc', 'Tự động nộp bài khi hết giờ')}
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                <input
            ...
            <div className="flex items-start justify-between p-4 bg-rose-50 dark:bg-rose-900/20 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white">
                    {t('quizSettings.soundEffects', 'Hiệu ứng âm thanh')}
                  </h3>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  {t('quizSettings.soundEffectsDesc', 'Phát âm thanh khi trả lời đúng/sai')}
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                <input
          ...
          <div className="sticky bottom-0 bg-gray-50 dark:bg-slate-900 px-6 py-4 flex items-center justify-between border-t border-gray-200 dark:border-slate-700">
            ...
            <div className="flex gap-3">
              ...
              >
                ...
                {t('quizSettings.save', 'Lưu cài đặt')}
              </button>
            </div>
          </div>
        </motion.div>
