...
import { MultiplayerManager } from '../../multiplayer/components/MultiplayerManager';
...
const QuizPreviewPage: React.FC = () => {
  ...
  const convertToMultiplayerQuiz = (quiz: Quiz) => {
    return {
      id: quiz.id,
      title: quiz.title,
      category: quiz.category,
      description: quiz.description,
      estimatedTime: quiz.questions.length * 30, // 30 seconds per question estimation
      ...
      <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  ...
                  className="inline-flex items-center px-6 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-blue-50 transition-colors border border-blue-200"
                >
        ...
        {showGameModeModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-in fade-in duration-300">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 transform transition-all duration-300 scale-95 animate-in zoom-in-95">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
                Chọn phương thức làm bài
              </h3>
              ...
              <div className="space-y-4">
                ...
                <Link
                  to={`/quiz/${quiz.id}`}
                  className="block w-full p-6 bg-blue-50 hover:bg-blue-100 rounded-xl border-2 border-blue-200 hover:border-blue-300 transition-all duration-200 group hover:shadow-lg hover:scale-102"
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 group-hover:text-blue-600 transition-colors">
                        Chơi một mình, tập trung hoàn toàn vào việc học
                      </p>
                    </div>
                  </div>
                </Link>
                ...
                <button
                  ...
                  className="block w-full p-6 bg-purple-50 hover:bg-purple-100 rounded-xl border-2 border-purple-200 hover:border-purple-300 transition-all duration-200 group hover:shadow-lg hover:scale-102"
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-sm text-gray-600 group-hover:text-purple-600 transition-colors">
                        Thách đấu trực tuyến với bạn bè và người chơi khác
                      </p>
                    </div>
                  </div>
                </button>
              ...
              <button
                onClick={() => setShowGameModeModal(false)}
                className="mt-6 w-full py-3 text-gray-600 hover:text-gray-800 transition-colors font-medium"
              >
                Hủy
              </button>
            </div>
        ...
        {showMultiplayer && user && (
          <MultiplayerManager 
            selectedQuiz={convertToMultiplayerQuiz(quiz)}
            currentUserId={user.uid}
            currentUserName={user.displayName || user.email || 'Anonymous'}
            onBackToQuizSelection={() => setShowMultiplayer(false)}
          />
        )}
      </div>
    </div>
