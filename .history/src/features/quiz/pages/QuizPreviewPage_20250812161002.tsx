  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {showGameModeModal && console.log('Modal state is true, should render') && (
          <div 
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <Link
                  to={`/quiz/${quiz.id}`}
                  className="block w-full p-6 bg-blue-50 hover:bg-blue-100 rounded-xl border-2 border-blue-200 hover:border-blue-300 transition-all duration-200 group hover:shadow-lg transform hover:-translate-y-1"
                  onClick={() => setShowGameModeModal(false)}
                >
                ...
                <button
                  ...
                  className="block w-full p-6 bg-purple-50 hover:bg-purple-100 rounded-xl border-2 border-purple-200 hover:border-purple-300 transition-all duration-200 group hover:shadow-lg transform hover:-translate-y-1"
                >
                  <div className="flex items-center space-x-4">
