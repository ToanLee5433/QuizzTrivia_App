      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {showGameModeModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 animate-in fade-in duration-200">
              ...
              <div className="space-y-4">
                ...
                <Link
                  to={`/quiz/${quiz.id}`}
                  className="block w-full p-6 bg-blue-50 hover:bg-blue-100 rounded-xl border-2 border-blue-200 hover:border-blue-300 transition-colors group"
                ...
                <button
                  ...
                  className="block w-full p-6 bg-purple-50 hover:bg-purple-100 rounded-xl border-2 border-purple-200 hover:border-purple-300 transition-colors group"
                >
                  <div className="flex items-center space-x-4">
