...
import { loginSuccess } from '../../auth/store';
...
const AuthPage: React.FC = () => {
  ...
  const handleShowOTP = (verificationId: string, userCred: UserCredential) => {
  ...
  if (showOTPVerification && verificationId && userCredential) {
    return (
      <OTPVerification
  ...
  if (showForgotPassword) {
    return <ForgotPassword onClose={handleCloseForgotPassword} />;
  }
