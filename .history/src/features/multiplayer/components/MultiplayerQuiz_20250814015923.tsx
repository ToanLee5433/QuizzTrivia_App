...
const MultiplayerQuiz: React.FC<MultiplayerQuizProps> = ({
  ...
  console.log('🔍 Real-time gameData.questions:', currentGameData?.questions);
  console.log('🔍 Questions array:', questions);
  console.log('🔍 Current index:', currentQuestionIndex);
  console.log('🔍 Raw question at index:', questions[currentQuestionIndex]);
  console.log('🔍 RoomData quiz:', currentRoomData?.quiz);
  ...
  if (!hasRealQuizData) {
    ...
    const realQuestions = currentGameData?.questions || currentRoomData?.quiz?.questions || [];
        ...
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mb-4 p-3 bg-yellow-100 border border-yellow-300 rounded text-sm">
              ...
              <strong>Data Source:</strong> {currentGameData?.questions?.length ? 'GameData' : currentRoomData?.quiz?.questions?.length ? 'RoomData' : 'Fallback'}<br/>
