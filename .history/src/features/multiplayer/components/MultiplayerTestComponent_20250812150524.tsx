      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-6">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Tham gia phòng</h3>
            <p className="text-white/70 mb-4">Tham gia phòng có sẵn hoặc nhập mã phòng</p>
            <button
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-6">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Tạo phòng mới</h3>
            <p className="text-white/70 mb-4">Tạo phòng mới với quiz của bạn</p>
            <button
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-6">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Hướng dẫn</h3>
            <p className="text-white/70 mb-4">Tìm hiểu cách chơi multiplayer</p>
            <button
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-6">
          <h2 className="text-2xl font-bold text-white mb-4">Tính năng Multiplayer</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
            <div className="text-white/80">
              <h4 className="font-bold mb-2">🎯 Real-time Gaming</h4>
              <p className="text-sm">Chơi cùng lúc với bạn bè, đồng bộ thời gian thực</p>
            </div>
            <div className="text-white/80">
              <h4 className="font-bold mb-2">🏆 Leaderboard</h4>
              <p className="text-sm">Bảng xếp hạng trực tiếp, cạnh tranh điểm số</p>
            </div>
            <div className="text-white/80">
              <h4 className="font-bold mb-2">⚡ Quick Scoring</h4>
              <p className="text-sm">Điểm cao hơn khi trả lời nhanh và chính xác</p>
            </div>
            <div className="text-white/80">
              <h4 className="font-bold mb-2">🎮 Easy Setup</h4>
              <p className="text-sm">Tạo phòng đơn giản, chia sẻ mã tham gia</p>
            </div>
          </div>
        </div>
