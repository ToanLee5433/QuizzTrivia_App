        ...
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mb-4 p-3 bg-yellow-100 border border-yellow-300 rounded text-sm">
              ...
              <strong>Real Questions Available:</strong> {(gameData?.questions || roomData?.quiz?.questions || []).length}<br/>
              ...
              <details className="mt-2">
                <summary className="cursor-pointer font-bold">Original Question Data (From Server)</summary>
                <pre className="mt-2 text-xs bg-gray-100 p-2 rounded overflow-auto max-h-32">
                  {JSON.stringify(question, null, 2)}
                </pre>
              </details>
              <details className="mt-2">
                <summary className="cursor-pointer font-bold">GameData Questions</summary>
                <pre className="mt-2 text-xs bg-gray-100 p-2 rounded overflow-auto max-h-40">
                  {JSON.stringify(gameData?.questions, null, 2)}
                </pre>
              </details>
              <details className="mt-2">
                <summary className="cursor-pointer font-bold">RoomData Quiz</summary>
                <pre className="mt-2 text-xs bg-gray-100 p-2 rounded overflow-auto max-h-40">
                  {JSON.stringify(roomData?.quiz, null, 2)}
                </pre>
              </details>
            </div>
                <pre className="mt-2 text-xs bg-gray-100 p-2 rounded overflow-auto max-h-40">
