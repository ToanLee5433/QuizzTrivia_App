    ...
    const unsubscribe = onSnapshot(roomRef, (doc) => {
      if (doc.exists()) {
        ...
        if (data.status === 'starting') {
          // Game is starting - show 5 second countdown
          setGameStartCountdown(5);
          console.log('🚀 Game starting countdown: 5 seconds');
        }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {currentGamePhase === 'finished' && (
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center mb-6">
            ...
            <div className="text-sm text-gray-500">Final leaderboard will be shown here</div>
          </div>
        )}
