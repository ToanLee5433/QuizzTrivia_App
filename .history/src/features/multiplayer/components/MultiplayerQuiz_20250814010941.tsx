...
const MultiplayerQuiz: React.FC<MultiplayerQuizProps> = ({
  ...
  console.log('🎮 MultiplayerQuiz Debug:', {
    ...
    questionOptions: question?.options || 'No options',
    optionsLength: question?.options?.length || 0,
    // Enhanced debugging for question structure
    questionKeys: question ? Object.keys(question) : 'No question keys',
    rawQuestion: JSON.stringify(question, null, 2),
        ...
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mb-4 p-3 bg-yellow-100 border border-yellow-300 rounded text-sm">
              ...
              Question Index: {currentQuestionIndex}/{questions.length}
            </div>
          )}
