...
import { 
  ...
  ChevronRight,
  X
} from 'lucide-rea              ${hoveredMode === 'multiplayer' 
                ? 'border-purple-400/50 bg-gradient-to-br from-purple-500/10 to-purple-600/5 scale-105 shadow-2xl shadow-purple-500/20' 
...
const GameModeSelector: React.FC<GameModeSelectorProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-2xl border border-white/10 p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto transform transition-all duration-500 scale-95 opacity-0 animate-pulse"
      ...
      >
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <h2 className="text-3xl font-bold text-white mb-2 transform transition-all duration-500 translate-x-0">
              Chọn chế độ chơi
            </h2>
            <p className="text-white/70 transform transition-all duration-500 translate-x-0">
          ...
          <button
            onClick={onClose}
            className="p-2 bg-white/10 hover:bg-white/20 rounded-full transition-all duration-300 hover:scale-110 transform"
          >
