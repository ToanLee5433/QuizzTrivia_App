  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-100 p-2 sm:p-4 lg:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        {currentGamePhase === 'results' && questionResults && (
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
            ...
            <div className="space-y-2">
              {questionResults.playerAnswers.map((result, index) => (
                <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">+{result.points} pts</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        {(!currentRoomStatus || currentRoomStatus === 'active') && currentGamePhase !== 'finished' && gameStartCountdown === null && (
          <>
        {/* Header */}
